...
const Newsletter = () => {
  ...
  const handleEmailSubmit = (e) => {
    e.preventDefault();
    axios
      .post("https://650df10fa8b42265ec2cd7c0.mockapi.io/newsletter", {
        email: email,
        header,
      })
      .then(
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light text-gray-800 md:mb-12 sm:text-xl ">
            Subscribe to our newsletter today for a weekly dose of inspiration,
            valuable insights, and exclusive offers delivered right to your
            inbox.
          </p>
          <form>
